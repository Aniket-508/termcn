...
```bash
npx shadcn@latest add https://termcn.dev/r/big-text.json
```
...
<ComponentSource name="big-text" title="components/ui/big-text.tsx" />
...
<ComponentPreview name="big-text-fonts" />
