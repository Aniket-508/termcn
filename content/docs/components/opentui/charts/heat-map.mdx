...
<ComponentPreview name="heat-map-demo" hideCode />
...
```bash
npx shadcn@latest add https://termcn.dev/r/heat-map.json
```
...
<ComponentSource name="heat-map" title="components/ui/heat-map.tsx" />
