...
<ComponentPreview name="tool-approval-demo" hideCode />
...
```bash
npx shadcn@latest add https://termcn.dev/r/tool-approval.json
```
...
<ComponentSource name="tool-approval" title="components/ui/tool-approval.tsx" />
