...
<ComponentPreview name="diff-view-demo" hideCode />
...
```bash
npx shadcn@latest add https://termcn.dev/r/diff-view.json
```
...
<ComponentSource name="diff-view" title="components/ui/diff-view.tsx" />
