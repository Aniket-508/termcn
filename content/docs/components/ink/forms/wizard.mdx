...
<ComponentPreview name="wizard-demo" hideCode />
...
```bash
npx shadcn@latest add https://termcn.dev/r/wizard.json
```
...
<ComponentSource name="wizard" title="components/ui/wizard.tsx" />
