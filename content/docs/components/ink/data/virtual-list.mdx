...
<ComponentPreview name="virtual-list-demo" hideCode />
...
```bash
npx shadcn@latest add https://termcn.dev/r/virtual-list.json
```
...
<ComponentSource name="virtual-list" title="components/ui/virtual-list.tsx" />
