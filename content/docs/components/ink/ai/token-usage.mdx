...
<ComponentPreview base="ink" name="token-usage-demo" hideCode />
...
```bash
npx shadcn@latest add @termcn/token-usage
```
...
<ComponentSource base="ink" name="token-usage" title="components/ui/token-usage.tsx" />
