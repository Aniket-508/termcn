...
<ComponentPreview name="token-usage-demo" hideCode />
...
```bash
npx shadcn@latest add https://termcn.dev/r/token-usage.json
```
...
<ComponentSource name="token-usage" title="components/ui/token-usage.tsx" />
