...
<ComponentPreview name="file-change-demo" hideCode />
...
```bash
npx shadcn@latest add https://termcn.dev/r/file-change.json
```
...
<ComponentSource name="file-change" title="components/ui/file-change.tsx" />
