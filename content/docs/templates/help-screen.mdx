...
<ComponentPreview name="help-screen-demo" hideCode />
...
```bash
npx shadcn@latest add https://termcn.dev/r/help-screen.json
```
...
<ComponentSource name="help-screen" title="components/ui/help-screen.tsx" />
