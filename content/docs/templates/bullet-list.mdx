...
<ComponentPreview name="bullet-list-demo" hideCode />
...
```bash
npx shadcn@latest add https://termcn.dev/r/bullet-list.json
```
...
<ComponentSource name="bullet-list" title="components/ui/bullet-list.tsx" />
