...
<ComponentPreview name="usage-monitor-demo" hideCode />
...
```bash
npx shadcn@latest add https://termcn.dev/r/usage-monitor.json
```
...
<ComponentSource name="usage-monitor" title="components/ui/usage-monitor.tsx" />
