...
<ComponentPreview name="login-flow-demo" hideCode />
...
```bash
npx shadcn@latest add https://termcn.dev/r/login-flow.json
```
...
<ComponentSource name="login-flow" title="components/ui/login-flow.tsx" />
