...
export const UnicodeContext = createContext<UnicodeContextValue>({
  unicode: !isNoUnicode(),
});

export const useMotion = (): MotionContextValue => useContext(MotionContext);

export const useUnicode = (): boolean => useContext(UnicodeContext).unicode;
...
export const ThemeProvider = ({
  ...
  const unicodeValue = useMemo<UnicodeContextValue>(
    () => ({
...
export const useThemeUpdater = (): ((theme: Theme) => void) =>
  useContext(ThemeContext).setTheme;
